...
const API_KEY_CONFIGS: ApiKeyConfig[] = [
  {
    ...
    patternHint: 'Should start with "pplx-" followed by 40+ characters',
    unlocks: 'Standard & Deep tiers',
  ...
  },
  {
    ...
    patternHint: 'Should start with "sk-" followed by 20+ characters',
    unlocks: 'Enhanced synthesis',
  ...
  },
  {
    ...
    patternHint: 'Should start with "sk-ant-" followed by 20+ characters',
    unlocks: 'Advanced analysis',
  ...
  },
  {
    ...
    patternHint: 'Should start with "AIza" followed by 30+ characters',
    unlocks: 'Free tier synthesis',
